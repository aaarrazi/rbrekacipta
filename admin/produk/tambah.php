...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $conn->query("INSERT INTO produk (id_kategori, nama_produk, harga, gambar)
                  VALUES ('$id_kategori', '$nama', '$harga', '$gambar')");
...
<head>
    ...
    <title>RB Reka Cipta (Admin) | Tambah Produk</title>
            ...
            <div class="card-body">
                <form method="post" enctype="multipart/form-data">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="bi bi-save2"></i> Simpan Produk
                    </button>
                </form>
            </div>
        </div>
